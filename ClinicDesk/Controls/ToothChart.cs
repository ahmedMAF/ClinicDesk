...
public partial class ToothChart : Control
{
    ...
    private readonly List<PointF[][]> _upperAdultTeethCurvesLeftHalf =
    [
        [
    ...
    private readonly List<PointF[][]> _upperBabyTeethCurvesLeftHalf =
    [
        [
    ...
    private void CreateTeeth()
    {
        ...
        for (int i = 0; i < 16; i++)
        {
            ...
            RectangleF bounds = path.GetBounds();
            Matrix flipY = new Matrix(1, 0, 0, -1, 0, bounds.Top + bounds.Height);
